...
class AnimationCard extends StatelessWidget {
  AnimationCard(
      {this.child, this.animation, this.direction, this.scaleAnimation});
  ...
  Widget build(BuildContext context) {
    return AnimatedBuilder(
      ...
      builder: (BuildContext context, Widget? child) {
        ...
        //   transform.translate(-10 * scaleAnimation!.value);
        // }
        return Transform(
          transform: transform,
...
class FlipCardState extends State<FlipCard>
  ...
  void initState() {
    ...
    //   duration: Duration(milliseconds: widget.speed),
    //   reverseDuration: Duration(milliseconds: widget.speed),
    //   vsync: this,
    // );
    _scaleAnimation = Tween<double>(begin: 1.2, end: 1.0)
  ...
  Future<void> toggleCard() async {
    ...
    final animation = isFront ? forward() : reverse();
